    ...
    <div className="w-full">
      <div className="max-w-screen-xl mx-auto py-10 flex gap-32">
        <div className="basis-1/2">
          <h1 className="select-none text-[11.5rem] font-semibold leading-none tracking-tight">
            refokus.
          </h1>
        </div>
        <div className="basis-1/2 flex gap-4">
          <div className="basis-1/3">
            ...
            {["Instagram", "Twitter (X?)", "LinkedIn"].map((e, i) => (
              <a className="cursor-pointer text-zinc-600 mt-2 capitalize block">{e}</a>
            ))}
          </div>
          <div className="basis-1/3">
            <h4 className="text-zinc-500 mb-10 capitalize">Sitemap</h4>
            {["Home", "work", "careers", "contact"].map((e, i) => (
              <a className="text-zinc-400 cursor-pointer font-medium mt-2 capitalize block">
                {e}
              </a>
            ))}
          </div>
          <div className="basis-1/2 flex flex-col items-end justify-end">
            ...
            <img
              className="w-32 mt-12 cursor-pointer"
