...
function NavBgPicker({showNavBtnBg,setNavBtnBgColor,setShowNavBtnBg}) {
  const [hue, setHue] = useState(0); 
      ...
      const setColorHandler = () => {
        setNavBtnBgColor(hex);
        console.log(setNavBtnBgColor)
      ...
      return (
        <div
          className={`py-1 px-5 space-y-2 
            ...
            ${showNavBtnBg   ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}
        >
          <div>
