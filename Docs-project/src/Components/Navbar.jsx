  ...
  return (
    <div className="py-4 flex justify-between items-center px-12 rounded-bl-xl rounded-br-xl bg-zinc-100 w-full" style={{backgroundColor:navColor}}>
      <button onClick={settingBtnHandler}>
        <h3 className="font-semibold text-lg flex items-center gap-2" style={{color:navFontColor}}>
          {" "}
          <span >
            <IoSettings className={`text-2xl ${showSettings?"rotate-90":""}  transition-all duration-300`} style={{color:navFontColor}} />
          </span >{" "}
          Settings
        </h3>
      </button>
