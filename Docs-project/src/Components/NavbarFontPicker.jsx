...
function NavbarFontPicker({showNavFont,setShowNavFont,setNavFontColor}) {
    ...
    return (
      <div
        className={`py-1 px-5 space-y-2 
          ...
          ${showNavFont ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}
      >
        <div>
...
export default NavbarFontPicker