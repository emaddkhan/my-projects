...
function NavBtnFontPicker({showNavBtnFont,setShowNavBtnFont,setNavBtnFontColor}) {
  const [hue, setHue] = useState(0); 
        ...
        const setColorHandler = () => {
          setNavBtnFontColor(hex);
          console.log(setNavBtnFontColor)
          setShowNavBtnFont(false);
        };
      
        return (
          <div
            className={`py-1 px-5 space-y-2 
              overflow-hidden transition-all duration-500 ease-in-out
              ${showNavBtnFont   ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}
          >
            <div>
...
export default NavBtnFontPicker