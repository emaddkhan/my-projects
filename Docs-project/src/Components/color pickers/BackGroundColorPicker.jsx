...
function BackGroundColorPicker({showBgPicker,setShowBgPicker,setBackgroundMainColor}) {
  const [hue, setHue] = useState(0);
    ...
    const setColorHandler = () => {
      setBackgroundMainColor(hex);
      console.log(setBackgroundMainColor);
    ...
    return (
      <div
        className={`py-1 px-5 space-y-2 
                ...
                ${showBgPicker ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}
      >
        <div>
