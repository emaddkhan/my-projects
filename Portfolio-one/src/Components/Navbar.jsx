    ...
    <div className="nav w-[85.4%] fixed top-5 z-50 h-[9vh] bg-brand-navGrey flex justify-between items-center rounded-full shadow-lg shadow-gray-600/30">
      <div className="download w-[19.5%] flex justify-center items-center">
        <a
          href="/Profile.pdf"
          download
          className="text-white downloadBtn bg-brand-black font-semibold px-16 py-3 rounded-full"
        >
          Download Resume
        </a>
      </div>
...
>
  <div className="flex flex-col items-center justify-center h-full gap-4">
    <a href="#home"  onClick={() => setOpen(false)} className="text-white font-semibold">Home</a>
    <a href="#about"  onClick={() => setOpen(false)} className="text-white font-semibold">About</a>
    <a href="#work"  onClick={() => setOpen(false)} className="text-white font-semibold">Projects</a>
    <a href="#contact"  onClick={() => setOpen(false)} className="text-white font-semibold">Contacts</a>
  </div>
</div>
